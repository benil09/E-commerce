    ...
    <nav className="bg-white shadow-md fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/" className="text-gray-700 hover:text-blue-600"><ShoppingCart /></Link>
            <Link to="/shop" className="text-gray-700 hover:text-blue-600"><Heart /></Link>
            <Link to="/about" className="text-gray-700 hover:text-blue-600"><CircleUser /></Link>
          </div>
